...
const ProfileScreens = () => {
  ...
  const username = currentUser?.username ? `@${currentUser.username}` : "@unknown";
  const bio = currentUser?.bio || "No bio available";
  const location = currentUser?.location ? `${currentUser.location}` : "Location not set";
...
{/* User Info */}
          <View className="mb-4">
            ...
            <View className="mb-3 px-2 py-1 bg-gray-100 rounded-md">
            ...
            <View className="flex-row items-center mb-3">
              ...
              <Text className="text-gray-500 ml-2">Joined {joinedDate}</Text>
            </View>
