...
import { View, Text, Alert, TouchableOpacity, TextInput,Image , ScrollView, Modal} from "react-native";
  ...
  return (
    ...
    {/* HEADER */}
      ...
      <View className="px-4 py-2 border-t border-gray-50 bg-gray-50">
       ...
       <Modal visible={isChatOpen} animationType="slide" presentationStyle="formSheet"> 
        {
